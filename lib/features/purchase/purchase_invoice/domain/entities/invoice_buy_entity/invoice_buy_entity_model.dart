...
class InvoiceBuyEntity implements BusinessModel {
  int invoiceNo;
  String userNumber;
  num? clientVendorNo;
  String aName;
  ...
  @override
  factory InvoiceBuyEntity.fromJson(Map<String, dynamic> json) =>
      _$InvoiceBuyEntityFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$InvoiceBuyEntityToJson(this);
}
