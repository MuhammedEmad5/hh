...
part 'invoice_buy_model.g.dart';

@JsonSerializable(explicitToJson: true)
class InvoiceBuy implements JsonModel {
  int VendorId;
  num buildingNo; //1
  int invoiceNo;
  String userNumber;
...
// 		0x000000000009304B
  ...
  @override
  factory InvoiceBuy.fromJson(Map<String, dynamic> json) =>
      _$InvoiceBuyFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$InvoiceBuyToJson(this);
}



// inventory1StaffNo (INTEGER)
// inventory2StaffNo (INTEGER)
// depositNo (INTEGER)
// personNo2 (INTEGER)
// carNo (INTEGER)
// driverNo (INTEGER)
...
// regionNo (REAL(27))
// agentNo (INTEGER)
// staffNo1_personNo (INTEGER)
// staffNo2_personNo (INTEGER)
// staffNo3_personNo (INTEGER)
// exportImportType (INTEGER)
// IDCard (TEXT(27))
// gaztInvoiceNumber (TEXT(20))
// gaztUniqueInvoiceIdentifier (TEXT(40))
// gaztInvoiceTypeCode (INTEGER)
// gaztInvoiceTypeCode_SubType (INTEGER)
// gaztLatestDeliveryDate (TEXT)
// gaztInvoiceHash (TEXT(100))
// gaztPreviousInvoiceHash (TEXT(100))
// isAgentGivenHisMoney (INTEGER)
// isZakatOutside (INTEGER)
// departmentJobNo (REAL(27))
// billTypeNo_Second (INTEGER)