...
/// {@template package:InvoiceF_Configuration/features/configuration/user_registration/data/mapper/person_mapper.dart}
/// Available mappings:
/// - `User` → `Person`.
/// - `Person` → `User`.
/// {@endtemplate}
class $PersonMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:InvoiceF_Configuration/features/configuration/user_registration/data/mapper/person_mapper.dart}
  @override
