...
class InvoiceSellUnit implements JsonModel {
  int invoiceNo;
  num buildingNo;
  int VendorId;
  int orderNo;
  ...
  @override
  factory InvoiceSellUnit.fromJson(Map<String, dynamic> json) =>
      _$InvoiceSellUnitFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$InvoiceSellUnitToJson(this);
}
