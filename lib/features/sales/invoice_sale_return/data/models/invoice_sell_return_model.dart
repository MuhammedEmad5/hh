...
part 'invoice_sell_return_model.g.dart';

@JsonSerializable(explicitToJson: true)
class InvoiceSellReturn implements JsonModel {
  int VendorId;
  num buildingNo; //1
  int invoiceNo;
  String userNumber;
...
// 		0x000000000009304B
  ...
  @override
  factory InvoiceSellReturn.fromJson(Map<String, dynamic> json) =>
      _$InvoiceSellReturnFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$InvoiceSellReturnToJson(this);
}
